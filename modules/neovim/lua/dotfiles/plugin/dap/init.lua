...
local function add_commands()
	vim.api.nvim_create_user_command("DapSetBreakpoint", set_breakpoint_cmd, { nargs = "*", force = true })
	vim.api.nvim_create_user_command("DapToggleBreakpoint", toggle_breakpoint_cmd, { nargs = "*", force = true })
	vim.api.nvim_create_user_command("DapSetLogpoint", set_logpoint_cmd, { nargs = 1, force = true })
	vim.api.nvim_create_user_command("DapToggleLogpoint", toggle_logpoint_cmd, { nargs = 1, force = true })

	vim.api.nvim_create_user_command("DapDebugTest", debug_test, { force = true })
