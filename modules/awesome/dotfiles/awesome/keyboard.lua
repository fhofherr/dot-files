...
-- {{{ Global key bindings
local global_keys = gears.table.join(awful.key({M.mod}, "s",
                                               hotkeys_popup.show_help, {
    description = "show help",
    group = "awesome"
}), awful.key({ctrl, alt}, "Left", awful.tag.viewprev,
              {description = "view previous", group = "tag"}),
                                     awful.key({ctrl, alt}, "Right",
                                               awful.tag.viewnext, {
    description = "view next",
    group = "tag"
}), awful.key({M.mod}, "Escape", awful.tag.history.restore,
...
-- Layout manipulation
    ...
    group = "screen"
}), awful.key({M.mod}, "u", awful.client.urgent.jumpto,
...
-- Standard program
    ...
    awful.spawn(apps.terminal)
                                     ...
                                     awful.key({M.mod, ctrl}, "r",
                                               awesome.restart, {
    description = "reload awesome",
    group = "awesome"
}), awful.key({M.mod, "Shift"}, "q", awesome.quit,
...
-- Prompt
awful.key({M.mod}, "r", function() awful.screen.focused().mypromptbox:run() end,
...
awful.key({M.mod}, "F2", function() menubar.show() end,
...
--       table.
for i = 1, 9 do
    global_keys = gears.table.join(global_keys, -- View tag only.
...
M.client_keys = gears.table.join(awful.key({M.mod}, "f", function(c)
    ...
    description = "close",
    group = "client"
}), awful.key({M.mod, "Control"}, "space", awful.client.floating.toggle,
              {description = "toggle floating", group = "client"}),
                                 awful.key({M.mod, "Control"}, "Return",
                                           function(c)
