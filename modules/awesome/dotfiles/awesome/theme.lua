...
local function find_wallpaper()
    local wallpaper = os.getenv("HOME") ..
                          "/Wallpapers/kde_plasma_scenery_95_4k.png"
    if gfs.file_readable(wallpaper) then return wallpaper end
    return themes_path .. "default/background.png"
end

function M.set_wallpaper(s)
    if not beautiful.wallpaper then beautiful.wallpaper = find_wallpaper() end
...
local theme = {
    ...
    titlebar_close_button_normal = themes_path ..
        "default/titlebar/close_normal.png",
    titlebar_close_button_focus = themes_path ..
        "default/titlebar/close_focus.png",

    titlebar_minimize_button_normal = themes_path ..
        "default/titlebar/minimize_normal.png",
    titlebar_minimize_button_focus = themes_path ..
        "default/titlebar/minimize_focus.png",

    titlebar_ontop_button_normal_inactive = themes_path ..
        "default/titlebar/ontop_normal_inactive.png",
    titlebar_ontop_button_focus_inactive = themes_path ..
        "default/titlebar/ontop_focus_inactive.png",
    titlebar_ontop_button_normal_active = themes_path ..
        "default/titlebar/ontop_normal_active.png",
    titlebar_ontop_button_focus_active = themes_path ..
    ...
    titlebar_sticky_button_focus_inactive = themes_path ..
        "default/titlebar/sticky_focus_inactive.png",
    titlebar_sticky_button_normal_active = themes_path ..
        "default/titlebar/sticky_normal_active.png",
    titlebar_sticky_button_focus_active = themes_path ..
        "default/titlebar/sticky_focus_active.png",

    titlebar_floating_button_normal_inactive = themes_path ..
        "default/titlebar/floating_normal_inactive.png",
    titlebar_floating_button_focus_inactive = themes_path ..
        "default/titlebar/floating_focus_inactive.png",
    titlebar_floating_button_normal_active = themes_path ..
        "default/titlebar/floating_normal_active.png",
    titlebar_floating_button_focus_active = themes_path ..
        "default/titlebar/floating_focus_active.png",

    titlebar_maximized_button_normal_inactive = themes_path ..
        "default/titlebar/maximized_normal_inactive.png",
    titlebar_maximized_button_focus_inactive = themes_path ..
        "default/titlebar/maximized_focus_inactive.png",
    titlebar_maximized_button_normal_active = themes_path ..
        "default/titlebar/maximized_normal_active.png",
    titlebar_maximized_button_focus_active = themes_path ..
...
if lainh then
    ...
    theme.layout_cascadetile = lainh.icons_dir ..
                                   "layout/default/cascadetile.png"
    theme.layout_cascadetilew = lainh.icons_dir ..
                                    "layout/default/cascadetilew.png"
    ...
    theme.layout_centerfairw = lainh.icons_dir ..
                                   "layout/default/centerfairw.png"
    theme.layout_centerwork = lainh.icons_dir .. "layout/default/centerwork.png"
    theme.layout_centerworkh = lainh.icons_dir ..
                                   "layout/default/centerworkh.png"
    theme.layout_centerworkhw = lainh.icons_dir ..
                                    "layout/default/centerworkhwh.png"
